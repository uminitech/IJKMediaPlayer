...
- (UIImage *)screenshot;
- (void)screenshotToGallery:(void (^)(NSString *savedPath,
                                      NSError *error))completion;
- (void)startRecord;
- (void)stopRecordToGallery:(void (^)(NSString *savedPath,
                                      NSError *error))completion;
...
@property(nonatomic, retain) id<IJKMediaNativeInvokeDelegate>
    nativeInvokeDelegate;
...
void IJKFFIOStatCompleteDebugCallback(const char *url, int64_t read_bytes,
                                      int64_t total_size, int64_t elpased_time,
                                      int64_t total_duration);
void IJKFFIOStatCompleteRegister(void (*cb)(const char *url, int64_t read_bytes,
                                            int64_t total_size,
                                            int64_t elpased_time,
                                            int64_t total_duration));
